...
class Session
{
    ...
    public function refreshAccessToken($refreshToken)
    {
        ...
        $response = $this->request->account('POST', '/oauth/access_token.php', $parameters, $headers);
     ...
     *
     * @param string $authorizationCode The authorization code from DeezerAPI.
     *
    ...
    public function requestAccessToken($authorizationCode)
    {
        ...
        $response = $this->request->account('POST', '/oauth/access_token.php', $parameters, []);
